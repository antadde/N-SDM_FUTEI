...
# nsdm.covinfo(cov_path=cov_path, save_path=paste0(w_path,"scripts/",project,"/main/settings/"), time_cov=cov_time, focal_cov=cov_focal)
...
# Remove static covariates (CL11)
reg11_ix<-grep("_reg11_", lr_reg)
lr_reg=lr_reg[-reg11_ix]

# # Remove corrupted files
# corrupts<-c(
# "/cluster/work/eawag/p01002/nsdm/data/nsdm-project/covariates/reg/lulc/agg11/future/pixel/2050/1009/reg14/ch_lulc_agg11_future_pixel_2050_1009_reg14_1500.rds",
# "/cluster/work/eawag/p01002/nsdm/data/nsdm-project/covariates/reg/lulc/agg11/future/pixel/2040/1009/reg17/ch_lulc_agg11_future_pixel_2040_1009_reg17_1500.rds",
# "/cluster/work/eawag/p01002/nsdm/data/nsdm-project/covariates/reg/lulc/agg11/future/pixel/2045/1009/reg15/ch_lulc_agg11_future_pixel_2045_1009_reg15_3000.rds",
# "/cluster/work/eawag/p01002/nsdm/data/nsdm-project/covariates/reg/lulc/agg11/future/pixel/2055/1009/reg12/ch_lulc_agg11_future_pixel_2055_1009_reg12_3000.rds",
# "/cluster/work/eawag/p01002/nsdm/data/nsdm-project/covariates/reg/lulc/agg11/future/pixel/2035/1009/reg17/ch_lulc_agg11_future_pixel_2035_1009_reg17_3000.rds",
# "/cluster/work/eawag/p01002/nsdm/data/nsdm-project/covariates/reg/lulc/agg11/future/pixel/2060/1009/reg11/ch_lulc_agg11_future_pixel_2060_1009_reg11_1500.rds",
# "/cluster/work/eawag/p01002/nsdm/data/nsdm-project/covariates/reg/lulc/agg11/future/pixel/2025/541/reg18/ch_lulc_agg11_future_pixel_2025_541_reg18_3000.rds",
# "/cluster/work/eawag/p01002/nsdm/data/nsdm-project/covariates/reg/lulc/agg11/future/pixel/2060/762/reg18/ch_lulc_agg11_future_pixel_2060_762_reg18_3000.rds")

# lr_reg <- setdiff(lr_reg, corrupts)

# Recreate lr
lr<-c(lr_glo, lr_reg)

# update covinfo (2)
pop=which(!cov_info$file %in% lr)
cov_info2=cov_info[-pop,]
...
# if(length(lr2fst) > 0) {
  # pp <- mclapply(lr2fst, function(c) {
    ...
    # write.fst(r_df, sub(".rds$", ".fst", c), compress = 75)
# }, mc.cores = ncores)
# }
...
if(n_levels>1){
if(length(grep("_topo_", lr_reg, value=T))>0){
rst_reg<-readRDS(grep("_topo_", lr_reg, value=T)[1])
}else{
...
if(n_levels>1){
l2<-list(lr_reg=lr_reg, lr_glo=lr_glo, cov_info=cov_info2)
} else {
l2<-list(lr_glo=lr_glo, cov_info=cov_info2)}
