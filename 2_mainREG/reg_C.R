...
# fwrite(df_ensemble, paste0(scr_path,"/outputs/",project,"/d8_ensembles/reg/",nesting_method,"/",ispi_name,"/",ispi_name,"_reg_",nesting_method,"_ensemble.csv"))
...
# fwrite(df_ensemble_cv, paste0(scr_path,"/outputs/",project,"/d9_ensembles-cv/reg/",nesting_method,"/",ispi_name,"/",ispi_name,"_reg_",nesting_method,"_ensemble_cv.csv"))
...
if(nesting_method=="multiply"){
  ...
  # fwrite(df_ensemble_nested, paste0(scr_path,"/outputs/",project,"/d10_nested-ensembles/",nesting_method,"/",ispi_name,"/",ispi_name,"_reg_",nesting_method,"_ensemble.csv"))
  ...
  # fwrite(df_ensemble_nested_cv, paste0(scr_path,"/outputs/",project,"/d11_nested-ensembles-cv/",nesting_method,"/",ispi_name,"/",ispi_name,"_reg_",nesting_method,"_ensemble_cv.csv"))
